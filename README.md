...
เว็บไซต์รถมือสองสำหรับร้าน **เต็นรถบ้านต้า** ในลำปาง ประเทศไทย — สร้างด้วย Next.js (App Router) + TypeScript + Tailwind CSS รองรับ deploy บน **GitHub Pages** (subpath) และ **Cloudflare Pages** (root URL)
